    ...
    <div class="row justify-content-center">
      <div class="col-md-8 col-lg-6 col-xl-4">
        <div class="card" style="border-radius: 15px;">
          ...
          <div class="card-body pb-0">
            <div class="d-flex justify-content-between">
              <p class="text-dark"> Prix de la semaine :</p>
              <p class="text-dark"><?php echo $price ?> €</p>
            </div>
            <p class="small text-muted"><?php echo $place ?> places</p>
          ...
          <div class="card-body">
            <div class="text-center pb-2 mb-1">
              ...
              <button type="button" class="btn btn-primary">Louer maintenant</button>
            </div>
          </div>
        </div>
      </div>
